...
class Api::StudiesController < ApplicationController
  ...
  def get_possible_stage
    ...
    def send_word_result
      @status = true
      @msg = ""
      Rails.logger.debug "1111111111111"
      ...
      Rails.logger.debug "2222222222222"
  if @status == true
      ...
      chaining = 0
      chain_point =0
      Rails.logger.debug "3333333333333333333"
